...
func GetAdminContainers(w http.ResponseWriter, r *http.Request) {
	...
	containersDir := filepath.Join(projectPath, "containers")
	...
	if err != nil {
		...
		vii.WriteError(w, http.StatusInternalServerError, "Error reading containers: "+err.Error())
		return
	}
